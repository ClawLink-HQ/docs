...
<Steps>
  ...
  <Step title="Set up your client">
    ClawLink works three ways — the agent-agnostic CLI, the Hermes plugin, or the
    OpenClaw plugin. Pick one:

    <SetupTabs app="your first app" />

    Full details on each path are in [Install ClawLink](/install).
  </Step>
