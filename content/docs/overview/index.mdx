...
description: "Install ClawLink in any agent, pair your device, and connect apps through hosted flows."
icon: "House"
---
...
<Steps>
  ...
  <Step title="Install ClawLink in your agent client">
    Works with any agent — Claude, ChatGPT, Hermes, OpenClaw, and others. Run this in your terminal, or paste it wherever you chat with your agent:
    ...
    OpenClaw and Hermes also have native plugins. See [OpenClaw setup](/openclaw) and [Hermes setup](/hermes).
  </Step>
