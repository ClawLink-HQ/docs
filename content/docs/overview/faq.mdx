...
<AccordionGroup>
  ...
  <Accordion title="How do I add an integration that isn't listed?">
    Use **Dashboard > Request App**, or ask in the [Discord community](https://discord.gg/KjN3xcTvw4).
  </Accordion>
  ...
  <Accordion title="Is there a free plan?">
    New accounts get a **7-day free trial** with the first app included and no card required. After that, continue on **Starter** (\$7.99/mo) or **Ultra Heavy** (\$29.99/mo, 100,000 tool calls a month). See the [Billing](/billing) page for details.
  </Accordion>

  <Accordion title="How do I contact support?">
    The fastest path is the **support chat in the dashboard** — open it from the chat launcher and a real person replies within a few minutes. For bugs or feature requests, you can also post in the [Discord community](https://discord.gg/KjN3xcTvw4). For security issues, email **security@claw-link.dev**.
  </Accordion>
</AccordionGroup>
