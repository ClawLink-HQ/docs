...
- **Simple pricing** — new accounts start with a 7-day free trial (first app included, no card), then **Starter** (\$7.99/mo) or **Ultra Heavy** (\$29.99/mo, 100,000 tool calls a month).
