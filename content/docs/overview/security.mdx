...
For the full picture of these boundaries — including how credentials are encrypted and handled — see the [Security Overview](https://claw-link.dev/security). If your security team needs to review this in more depth, email **security@claw-link.dev**.
...
<Steps>
  <Step title="Go to Settings > API Keys">
    Open the [ClawLink dashboard](https://claw-link.dev/sign-in) and navigate to **Settings > API Keys**.
  </Step>
