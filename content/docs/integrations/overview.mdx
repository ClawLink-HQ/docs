...
<CardGroup cols={2}>
  ...
  <Card title="Public data apps" icon="radar" href="/integrations/public-data">
    Read-only TikTok, Instagram, X, YouTube, LinkedIn, Spotify and more. Nothing to connect, paid per call from your credit
  </Card>
